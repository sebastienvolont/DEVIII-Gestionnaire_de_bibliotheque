...
class getApiPlatform_Openapi_OptionsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.openapi.options'] = new \ApiPlatform\Core\OpenApi\Options('Symfony REST API', 'A Symfony API to manage a simple blog app.', '1.0.0', false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', '/oauth/v2/refresh', [], [], NULL, NULL, NULL, NULL, NULL, NULL);
    }
}
